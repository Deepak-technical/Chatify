          ...
          <div class="px-20 h-full text-gray-800 ">
            <div class="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
              <div class="grow-0 shrink-1 md:shrink-0 basis-auto xl:w-6/12 lg:w-6/12 md:w-9/12 mb-12 md:mb-0">
                ...
                <img
                  src="https://kit8.net/wp-content/uploads/2020/12/messages@2x.png"
                  class="w-4/5 justify-center mx-auto"
                  alt="Sample image"
                />
              <p class=" text-center text-4xl font-semibold my-4 pt-1 text-blue-600">Chatify-</p>
              <p className=" text-center text-2xl font-semibold my-2 pt-1 text-blue-600"> An new Way of Message to Teams</p>

              </div>
              
              <div class="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
              <form action="" onSubmit={(event) => handleSubmit(event)} className="w-3/5">
              <p class="text-3xl font-semibold my-8 pt-1 text-blue-600">Login to Chatify</p>
